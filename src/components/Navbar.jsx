        ...
        <nav className="bg-gray-100 fixed w-full  border-gray-200 dark:border-gray-600">
            <div className="max-w-screen-xl flex flex-wrap justify-between items-center mx-auto p-4">
                ...
                <div className="flex gap-4">
                    <button type="button" className="btn bg-blue-500 text-white">Ingreso Medico</button>
                    <button type="button" className="btn bg-red-600 text-white">Ingreso Paciente</button>
                </div>
            </div>
        </nav>
    )
